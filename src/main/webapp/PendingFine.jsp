            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <h2 class="text-center mb-0 fw-bold" style="color: var(--warning-color);">
                        <i class="fas fa-money-bill-wave me-2"></i>Pending Fines & Status
                    </h2>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success && response.data.length > 0) {
                            ...
                            $('#pendingFineBody').html('<tr><td colspan="6" class="text-center">No pending fines found</td></tr>');
                            $('#totalFineAmount').text('0.00');
                        }
                    },
                    error: function() { $('#pendingFineBody').html('<tr><td colspan="6" class="text-center text-danger">Error loading data</td></tr>'); }
                });
            }
            loadPendingFines();
            ...
            $('#printPdfBtn').click(function() {
                ...
                img.onload = function() {
                    ...
                    const headers = ["CRN", "Student Name", "Contact", "Due Date", "Total Fine (₹)", "Status"];
                    const data = [];
